This assignment uses the `products.ts` file in this folder. **Make sure to copy this file to your own project**. You can't import a file which is outside the project folder.
