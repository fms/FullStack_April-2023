...
// These are the same
const f1 = document.querySelector<HTMLInputElement>("#f1")!;
const f2 = document.querySelector("#f2") as HTMLInputElement;
const f3 = document.querySelector("#f3") as HTMLInputElement;
...
function submitInput2(event: Event) {
...
function saveDataMulti(obj: Object) {
