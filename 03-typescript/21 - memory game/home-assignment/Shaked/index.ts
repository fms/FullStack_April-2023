...
shuffledCards.forEach((imageSRC: string) => {
            ...
            if (!firstCard) {
                ...
                setTimeout(() => {
                    if (firstCard && secondCard) {
                        const img1 = firstCard.querySelector('.back img') as HTMLImageElement;
                        const img2 = secondCard.querySelector('.back img') as HTMLImageElement;
