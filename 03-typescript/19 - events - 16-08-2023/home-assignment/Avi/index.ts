let box: HTMLElement = document.querySelector('.main__box')!;
...
let gallery: HTMLElement = document.querySelector('.main__gallery')!;
let back: HTMLElement = document.querySelector('.back')!;
...
let pass1: HTMLInputElement = document.querySelector('.pass1')!;
let pass2: HTMLInputElement = document.querySelector('.pass2')!;
let check: HTMLElement = document.querySelector('.main__chek')!;
