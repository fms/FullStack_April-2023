abstract class Movie {
    ...
    constructor(name: string, length: string, language: string, releaseDate: Date, genre: string) {
        this.name = name;
        this.length = length;
...
class MarvelMovie extends Movie {
    ...
    constructor(name: string, length: string, releaseDate: Date, order: number, phase: number, hero: string) {
