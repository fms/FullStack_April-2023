...
console.log(`root style: ${root === null || root === void 0 ? void 0 : root.style}`);
if (root) {
...
if (spans) {
    ...
    spanArray.forEach(span => span.style.backgroundColor = "brown"); // );
}
// : HTMLCollectionOf<HTMLSpanElement>
function setColorBrown(span) {
    span.style.backgroundColor = "brown";
}
let classes = document.querySelector(".child");
if (classes) {
...
let allClasses = document.querySelectorAll(".child");
if (allClasses) {
    // spanArray.forEach(setColorBrown);
