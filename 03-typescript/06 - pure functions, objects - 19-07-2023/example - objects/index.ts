...
function increaseAge(user: user) {   // Pass by reference
...
// Pass by value
let num = 10;
function increase(num: number){     // num is a copy of the original value
...
function printDetails(user: any) {
    console.log(user.firstName);
}

function printAge(user: any) {
