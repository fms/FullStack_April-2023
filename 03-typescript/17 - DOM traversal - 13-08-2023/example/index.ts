function resetColors() {
    ...
    elements.forEach(element => (element as HTMLElement).style.backgroundColor = '');
}

function grandparentUsingId(color: string= "grey") {
...
function grandparentUsingQuerySelector(color: string= "grey") {
...
function parentsUsingClassNames(color: string = "grey") {
...
function parentsUsingQuerySelectorAll(color: string = "grey") {
...
function firstParentUsingQuerySelector(color: string= "grey") {
