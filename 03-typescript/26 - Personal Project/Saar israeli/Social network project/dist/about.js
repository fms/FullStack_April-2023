...
const contantNavLink = document.querySelector(".navbar-right__link--contact");
...
function toggleNavLinks() {
    ...
    LogginOutLinks(postsSection, postsNavLink);
    if (!profileSection.classList.contains("hidden")) {
        profileSection.classList.add("hidden");
    }
    LogginOutLinks(profileSection, profileNavLink);
    // if(!aboutSection.classList.contains("hidden")) {
    //     aboutSection.classList.add("hidden");
    // }
    // LogginOut(aboutSection,aboutNavLink);
    // if(!contactSection.classList.contains("hidden")) {
    //     contactSection.classList.add("hidden");
    // }
    // LogginOut(contactSection,contantNavLink);
}
function LogginOutLinks(section, navLink) {
