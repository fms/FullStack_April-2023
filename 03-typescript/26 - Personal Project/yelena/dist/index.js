...
if (classesContainer) {
    schoolClasses.forEach((schoolClass) => {
        classesContainer.insertAdjacentHTML("beforeend", `<div class="image school-class" data-title="${schoolClass.title}">
 ...
 */
function hidePopup() {
    const popup = document.getElementById('popup'); // Adjust the selector as needed
    if (popup) {
 ...
 */
function showPopup(description, time, teacher) {
    const popup = document.getElementById('popup'); // Adjust the selector as needed
    const popupText = document.getElementById('popup_text'); // Adjust the selector as needed
    if (popup && popupText) {
