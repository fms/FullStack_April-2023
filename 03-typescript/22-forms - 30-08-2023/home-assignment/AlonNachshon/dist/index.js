...
class TaskSystem {
    constructor() {
        ...
        this.tasksMap = new Map(); /* Map of Task lists*/
        this.idCounter = 1000;
        this.listsNames = new Map();
...
class TaskList {
    ...
    addTaskToList(task) {
        ...
        (_a = taskHomePage.tasksMap.get(task.id)) === null || _a === void 0 ? void 0 : _a.list = this.name;
        ...
        deleteTask === null || deleteTask === void 0 ? void 0 : deleteTask.addEventListener("click", (ev) => {
            ...
            tasksToDelete.forEach((task) => {
                ...
                if (task.checked) {
                    ...
                    (_b = taskHomePage.listsNames.get(this.name)) === null || _b === void 0 ? void 0 : _b.deleteTaskFromList(taskHomePage.tasksMap.get(parseInt(taskId)));
...
update === null || update === void 0 ? void 0 : update.addEventListener("click", (ev) => {
    var _a;
    ev.preventDefault();
    if (taskHomePage.updateTask == null)
        return;
    /**
    ...
    const selectTask = document.getElementById("chooseTaskList");
    const selectedList = selectTask === null || selectTask === void 0 ? void 0 : selectTask.value;
    const taskId = document.getElementById(taskHomePage.updateTask.id.toString());
    ...
    if (selectedList != "") { /* Selected list is not an empty string, so need to change between lists (assuming) in the future take care of same list choosen*/
        ...
        const taskList = document === null || document === void 0 ? void 0 : document.querySelector(`.tasktslist-${taskHomePage.updateTask.list}`);
