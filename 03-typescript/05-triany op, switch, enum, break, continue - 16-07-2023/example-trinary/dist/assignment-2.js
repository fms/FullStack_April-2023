"use strict";
function maxWithVarAndElse(num1, num2) {
    let largerNum; // result
    if (num1 > num2) {
...
function maxEarlyReturn(num1, num2) {
    if (num1 > num2) {
...
function maxTrinary(num1, num2) {
    return (num1 > num2 ? // cond
        num1 : // true result
        num2); // false result
}
