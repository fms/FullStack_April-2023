...
const negateNumber = (x: number) => console.log(`${-x}`);

negateNumber(num1);
negateNumber(num2);

// Mission #2
const largerTest = (num1: number, num2: number) => {
...
// Mission #3
const fahrenheitToCelsius = (F: number) => console.log(`${((F - 32) * 5) / 9}`);
fahrenheitToCelsius(77);

// Mission #4
const mathGenerator = (a: number, b: number, op: number) => {
