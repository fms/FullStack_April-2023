...
export function updateProductPriceBody(
  req: express.Request,
...
export function updateProductPriceQuery(
  req: express.Request,
  res: express.Response
) {
  try {
...
export function overwriteProductBody(
  req: express.Request,
  res: express.Response
) {
  try {
...
export function overwriteProductQuery(
  req: express.Request,
  res: express.Response
) {
  try {
