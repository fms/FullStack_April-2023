...
const updateButton: HTMLButtonElement | null = document.querySelector('#update_button');
// const updateForm: HTMLFormElement | null = document.querySelector(".update_form");
